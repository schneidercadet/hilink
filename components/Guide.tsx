  ...
  return (
    <section className='flexcenter flex-col'>
        <div className='padding-container max-container w-full pb-24'>
            ...
            lg:gap-10'>
                ...
                <p className='regular-16 text-gray-30 xl:max-w-[520px]'>
                    Only with the hilink application you will no longer get lost and get lost again, because we alredy
                    support offline maps when there is no internet connection in the field. Invite your friends and relatives
        ...
        <div className='flexCenter max-container relative w-full '>
            ...
            />
            <div className='absolute flex bg-white py-8 pl-5 pr-5 gap-3 rounded-3xl border
